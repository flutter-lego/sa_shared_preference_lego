...
class CheckSharedPreferences {
  static Future<Check> get() async {
    await _ready();

    String? data = _prefs.getString('CheckModel');

    if (data == null) return Check();

    return Check.fromDataString(data);
  }

  static Future<void> upsert(Check obj) async {
    await _ready();

    String data = obj.toDataString();

    await _prefs.setString('CheckModel', data);
  }

  static Future<void> delete() async {
    await _ready();

    await _prefs.remove('CheckModel');
  }
